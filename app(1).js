...
const BATCH_SIZE = 20;
// Invite code(s) come from config.js, which is gitignored so it never ends
// up in your GitHub repo. Copy config.example.js to config.js, set your
// real code(s), and add <script src="config.js"></script> to your HTML
// (in public/index.html for CRA/Vite) before your bundled app script.
